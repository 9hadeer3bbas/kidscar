...
class _NotificationTile extends StatelessWidget {
  ...
  final ParentNotificationsController controller;
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: isRead
                      ...
                      : ColorManager.secondaryColor.withValues(alpha: 0.08),
                  borderRadius: BorderRadius.circular(24.r),
                  border: Border.all(
                    color: isRead
  ...
  void _handleNotificationTap(Map<String, dynamic> notification) {
    ...
    switch (type) {
      ...
      case 'trip_completed':
      case 'trip_reminder':
        // Navigate to parent main view or trip details
        Get.back();
        break;
      case 'emergency':
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              child: _BlurCircle(
                diameter: 220.w,
                color: ColorManager.secondaryColor.withValues(alpha: 0.18),
              ),
            ),
          ],
        ),
