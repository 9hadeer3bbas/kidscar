...
import 'parent_edit_profile_controller.dart';

class ParentEditProfileView extends GetView<ParentEditProfileController> {
  const ParentEditProfileView({super.key});
